...
# NWX_LAPACK_INCLUDE_DIR to the path to your LAPACK distribution's header file
# and NWX_LAPACK_DEFINITIONS to the correct header file.
#
# This module defines
#  NWX_LAPACK_INCLUDE_DIRS, where to find lapacke.h or mkl.h
#  NWX_LAPACK_LIBRARIES, the libraries to link against for LAPACK support
#  NWX_LAPACK_DEFINITIONS, flags to include when compiling against LAPACK
#  NWX_LAPACK_LINK_FLAGS, flags to include when linking against LAPACK
#  NWX_LAPACK_FOUND, True if we found NWX_LAPACK
...
if(NOT __defs_set)
    if(__found_mkl)
        set(NWX_LAPACK_DEFINITIONS "LAPACKE_HEADER=mkl.h")
    else()
        set(NWX_LAPACK_DEFINITIONS "LAPACKE_HEADER=lapacke.h")
    endif()
endif()
